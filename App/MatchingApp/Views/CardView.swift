...
//  MatchingApp
//
//  Created by Joseph Wang on 2021/8/8.
//
...
class CardView: UIView {
    ...
    private let nameLabel = CardInfoLabel(frame: .zero, labelText: "Taro, 22", labelFont: .systemFont(ofSize: 20, weight: .regular))
    ...
    private let nopeLabel = CardInfoLabel(frame: .zero, labelText:"NOPE", labelColor: .rgb(red: 220, green: 110, blue: 110))
